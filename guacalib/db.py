...
class GuacamoleDB:
    ...
    CONNECTION_PARAMETERS = {
        ...
        'private-key': {
            'type': 'string',
            'description': 'The entire contents of the private key to use for public key authentication. If this parameter is not specified, public key authentication will not be used. The private key must be in OpenSSH format, as would be generated by the OpenSSH ssh-keygen utility.',
            'default': 'NULL',
            'table': 'parameter'
        },
        'hostname': {
